...
export default function CustomerView() {
  ...
  if (!customer) return <div className="customer-container">Please log in first</div>
      ...
      <div className="customer-wrapper">
        ...
        <div className="customer-card-profile">
          ...
          <div className="buttons-section">
            <button className="customer-btn" onClick={handleScheduleService}>Schedule Service</button>
            <button className="customer-btn" onClick={() => navigate('/history')}>View History</button>
          </div>
